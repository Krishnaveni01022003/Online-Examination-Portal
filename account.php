...
<Title> JSK || TEST YOUR SOFTWARE SKILL </Title>
...
<div class="row">
<div class="col-lg-6">
<span class="logo">Test Your Software Skill</span></div>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li <?php if(@$_GET['q']==1) echo'class="active"'; ?> ><a href="account.php?q=1"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>
        &nbsp;
        Home
    ...
    <a href="account.php?q=3">
      ...
      Ranking
		...
		<li class="pull-right"> <a href="logout.php?q=account.php"><span class="glyphicon glyphicon-log-out" aria-hidden="true">
    </span>
    &nbsp;&nbsp;&nbsp;&nbsp;
    Signout
  </a>
...
echo '<tr style="color:#99cc32"><td>'.$c++.'</td><td>'.$title.'&nbsp;<span title="This quiz is already solve by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></td><td>'.$total.'</td><td>'.$right*$total.'</td><td>'.$time.'&nbsp;min</td>
	<td><b><a href="update.php?q=quizre&step=25&eid='.$eid.'&n=1&t='.$total.'" class="pull-right btn sub1" style="margin:0px;background:red"><span class="glyphicon glyphicon-repeat" aria-hidden="true">
  </span>&nbsp;<span class="title1"><b>Restart</b></span></a></b></td></tr>';
}
}
$c=0;
echo '</table></div></div>';
...
echo'<br /><button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-lock" aria-hidden="true">
</span>&nbsp;Submit</button></form></div>';
...
echo  '<div class="panel">
<center>
<h1 class="title" style="color:#660033">
Result
</h1>
<center>
<br />
...
<a href="https://www.instagram.com/iam.krishuu/" target="_blank">Contact us</a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>
		<!--Developer1 Krishnaveni-->
		<div class="row">
		<div class="col-md-4">
		 <img src="image/krishnaveni.jpeg" width=180 height=140 alt="Krishnaveni Mudaliyar" class="img-rounded">
		 </div>
		<div class="col-md-5">
		<h4 style="color:#202020; font-family:'typo' ; font-size:18px">Krishnaveni Mudaliyar </h4>
		<h5 style="color:#rgb(255,0,0) ; font-weight:bold;">Email : Krishnaveni01022003@gmail.com
		<h4 style="font-family:'typo' "></h4>
	
		</div>
		<a href="https://www.instagram.com/iam.krishuu/" target="_blank">
		<img alt="Instagram" src="image/instagram.jpg" title="Follow me on Instagram" align="center" width=30" height="30"></a>
		</div>
		<hr>
